...
export default function SessionBooking() {
 ...
 const getVenueAccentColor = (venueId) => {
  const storyGradients = [
    ['#667eea', '#764ba2'], // Guidelines
    ['#f093fb', '#f5576c'], // Schedule
    ['#4facfe', '#00f2fe'], // Levels
    ['#fa709a', '#fee140'], // Tips
    ['#a8edea', '#fed6e3'], // Support
  ];
  ...
  const gradientIndex = id % storyGradients.length;
  return storyGradients[gradientIndex][0]; // Return the first color of the gradient
};
const getVenueBackgroundImage = (venueId) => {
  const backgroundImages = [
    { uri: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=1200' }, // Dark hall with chairs
    { uri: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200' }, // Moody conference room
    { uri: 'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=1200' }, // Auditorium dark tones
    { uri: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200' }, // Modern lobby dim lights
    { uri: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=1200' }, // Office space low light
  ];
...
// Replace the existing getVenueGradientColors function with this:
const getVenueGradientColors = (venueId) => {
  ...
  const gradientIndex = id % storyGradients.length;
  const selectedGradient = storyGradients[gradientIndex];
  
  // Create lighter versions for card background
  const darkColor = selectedGradient[0] + '15'; // 15% opacity
  const lighterColor = selectedGradient[1] + '25'; // 25% opacity
